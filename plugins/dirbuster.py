...
DEFAULT_ARGS = {
    "Aggressive": "-u {target} -l /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -x php,html,js,txt -t 50",
    "Normal":     "-u {target} -l /usr/share/wordlists/dirbuster/directory-list-2.3-small.txt",
    "Passive":    "DISABLED",
}
