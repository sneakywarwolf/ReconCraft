...
#DirBuster itself was written as a Swing/Java GUI application, so even when you pass arguments,
# So it still spawns the GUI and not a true CLI mode.

# Required
REQUIRED_TOOL = 'dirbuster'    # e.g., "nmap", "gobuster", "rustscan", "nuclei"
