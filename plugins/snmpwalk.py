...
# Required
REQUIRED_TOOL = "snmpwalk"    # e.g., "nmap", "gobuster", "rustscan", "nuclei"
INSTALL_HINT  = "apt"         # one: "apt" | "brew" | "choco" | "pip" | "go" | "git" | "manual" | "docker"

# Optional
INSTALL_URL   = "https://net-snmp.sourceforge.net/"  # Docs/repo page (shown to user for manual/git)
...
# Note:
# - Community string defaults to 'public' for quick checks; override via Custom or profile edits.
# - OID .1 walks the entire MIB tree (can be noisy). Tune to specific OIDs as needed.
DEFAULT_ARGS = {
