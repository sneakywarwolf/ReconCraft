...
# Required
REQUIRED_TOOL = 'naabu'    # e.g., "nmap", "gobuster", "rustscan", "nuclei"
INSTALL_HINT  = 'go'         # one: "apt" | "brew" | "choco" | "pip" | "go" | "git" | "manual" | "docker"

# Optional
INSTALL_URL   = 'github.com/projectdiscovery/naabu/v2/cmd/naabu'            # Docs/repo page (shown to user for manual/git)
EXECUTABLE    = 'naabu'            # How ReconCraft should call it; default = REQUIRED_TOOL
