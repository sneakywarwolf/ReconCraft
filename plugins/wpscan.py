REQUIRED_TOOL = "wpscan"
INSTALL_HINT = "apt"
INSTALL_URL = ""

DEFAULT_ARGS = {
    "Aggressive": "--url {target} --enumerate u,vp,vt,cb,dbe --random-user-agent --disable-tls-checks",
    "Normal":     "--url {target} --enumerate vp,vt --random-user-agent",
    "Passive":    "DISABLED",
}
