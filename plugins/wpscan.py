...
# Required
REQUIRED_TOOL = 'wpscan'    # e.g., "nmap", "gobuster", "rustscan", "nuclei"
...
DEFAULT_ARGS = {
    "Aggressive": "--url {{target}} --enumerate ap,at,tt,cb,u --plugins-detection aggressive --ignore-main-redirect",
    "Normal": "--url {{target}} --no-update --ignore-main-redirect",
    "Passive": "DISABLED",
    "Custom": "{{target}}"
}
