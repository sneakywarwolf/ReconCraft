REQUIRED_TOOL = "dirsearch"
INSTALL_HINT = "pip"
INSTALL_URL = ""

DEFAULT_ARGS = {
    "Aggressive": "-u {target} -e php,html,js,txt -w /usr/share/wordlists/dirb/common.txt --threads 50",
    "Normal":     "-u {target} -e php,html -w /usr/share/wordlists/dirb/common.txt",
    "Passive":    "DISABLED",
}
