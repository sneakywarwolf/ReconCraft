...
# Required
REQUIRED_TOOL = 'whatwaf'    # e.g., "nmap", "gobuster", "rustscan", "nuclei"
INSTALL_HINT  = 'pip'         # one: "apt" | "brew" | "choco" | "pip" | "go" | "git" | "manual" | "docker"

# Optional
INSTALL_URL   = 'https://github.com/Ekultek/WhatWaf'            # Docs/repo page (shown to user for manual/git)
