REQUIRED_TOOL = "gobuster"   # e.g., "nmap", "gobuster", etc.
INSTALL_HINT = "go"         # "apt", "brew", "pip", "go", or "manual"
...
def run(ip_or_domain, raw_dir, base_dir, run_command, check_tool_installed, extract_cves):
    ...
    cmd = ['gobuster', 'dir', '-u', 'http://ip_or_domain', '-w', '/usr/share/wordlists/dirb/common.txt']
